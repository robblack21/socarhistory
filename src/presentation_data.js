...
export const slides = [
  ...
  },
  {
    type: "spz",
    path: "citypano.spz", 
    startTime: 4.04, // "repeatedly described..." (Actually Medieval context starts around here or 5.96 "medieval scholars")
    duration: 6,
    year: "Medieval",
  ...
  },
  {
    type: "spz",
    path: "marcopolo.spz",
    startTime: 10.38, // "As Marco Polo wrote..."
    duration: 7,
    year: "14th C.",
  ...
  },
  {
    type: "spz",
    path: "refinery.spz",
    startTime: 18.52, // "Inscriptions on a stone..."
    duration: 9, 
    year: "1594",
  ...
  },
  {
    type: "spz",
    path: "oilwell.spz",
    startTime: 28.2, // "1847. A turning point..." (Eighteen forty-seven)
    duration: 8,
    year: "1847",
  ...
  },
  {
    type: "spz",
    path: "pipeline.spz",
    startTime: 36.5, // "1859. The first white..." (Approximation based on flow)
    duration: 12,
    year: "1859",
  ...
  },
  {
    type: "spz",
    path: "hotel.spz",
    startTime: 49.0, // "1877. The Nobel brothers..."
    duration: 10,
    year: "1877",
  ...
  },
  {
    type: "spz",
    path: "train.spz",
    startTime: 62.0, // "1878. The railway..."
    duration: 10,
    year: "1878",
  ...
  },
  {
    type: "spz",
    path: "rigs.spz",
    startTime: 72.0, // "1907. Baku's oil..."
    duration: 12,
    year: "1907",
  ...
  },
  {
    type: "glb",
    path: "socar1992.glb",
    startTime: 85.0, // "1930. For the first time..."
    duration: 8,
    year: "1930",
  ...
  },
  {
    type: "spz",
    path: "platforms.spz",
    startTime: 108.0, // "1949. Azerbaijan was also..."
    duration: 10,
    year: "1949",
  ...
  },
  {
    type: "img",
    path: "map2.png",
    startTime: 133.0, // "The billionth ton..."
    duration: 8,
    year: "1992",
  ...
  },
  {
    type: "spz",
    path: "flag.spz",
    startTime: 145.0, // "1994. On September 20..."
    duration: 12,
    year: "1994",
  ...
  },
  {
    type: "spz",
    path: "contract.spz",
    startTime: 160.0, // "The agreement, signed by..."
    duration: 10,
    year: "Signed",
  ...
  },
  {
    ...
    orbitScale: 0.0,
    transform: { position: [0, 2.1, 0], scale: [1.0, 1.0, 1.0], rotation: [0, 0, 0] }, 
  },
];
